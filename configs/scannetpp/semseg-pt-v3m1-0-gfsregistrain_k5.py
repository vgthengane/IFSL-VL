from pointcept.datasets.preprocessing.scannetpp.metadata.semantic_benchmark.top100 import (
...
backbone_weight = "./exp/scannetpp/ptv3_bk/model/model_best.pth"
# model settings
model = dict(
...
epoch = 20
eval_epoch = 20
optimizer = dict(type="Adam", lr=0.007)
scheduler = dict(
    type="MultiStepLR",
    milestones=[50, 100],
    gamma=0.5,
)
param_dicts = [dict(keyword="backbone", lr=0.0007)]
...
data = dict(
    ...
    train=dict(
        type="ScanNetPPDataset_REGISTrain",
